...
export default function PaymentForm() {
  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-center gap-4 p-8 bg-white relative">
      ...
      >
        <div className="p-3 -mt-60 animate-spin drop-shadow-2xl bg-gradient-to-bl from-pink-400 via-purple-400 to-indigo-600 md:w-48 md:h-48 h-32 w-32 aspect-square rounded-full">
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          ...
          <div className="input flex flex-col w-full static">
            ...
            >
              ...
              <option value="10">10x de {formatToCurrencyBR(half / 10)}</option>
              <option value="11">11x de {formatToCurrencyBR(half / 11)}</option>
