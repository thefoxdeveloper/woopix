...
export default function PixOne({ value, cashback, isSelected }: PixOneProps) {
  ...
  return (
    <RadioGroup.Item value={"x"} className="w-full">
      <div
        id="highlightedPix"
        className={`relative ${
      ...
      >
        ...
        <div className="justify-between flex items-center">
          <span className="text-[#03D69D] font-semibold text-base">
            Ganhe
            <span className="text-[#03D69D] font-semibold mx-1">
              {cashback}%
            </span>
            de Cashback
          </span>
        ...
        <div className="justify-between flex items-center">
          <div className="bg-[#133A6F] rounded-md h-8 w-full flex items-center p-2 mt-2 relative">
            ...
            <span className="text-white text-[0.625rem] sm:text-sm font-semibold w-11/12 text-left">
              🤑
